...
class OperativesGame2 extends Component{ // Still not 100% sure whether to change this to a class, or to just useState
    ...
    setColor(){
        var cardColorArray =[
            ...
            ['red', 'blue', 'nuetral', 'nuetral', 'nuetral'],
            ['red','black', 'red', 'blue', 'nuetral'],
            ['blue', 'nuetral', 'red', 'nuetral', 'red'],
            ['nuetral', 'blue', 'nuetral', 'red', 'blue']
        ];
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <form class="col-md-7" onSubmit={this.handleGuessSubmit}> {/* Incorporate a form here so that all checkboxes can be submitted? */}
                                <div class="row">
                                    <div class="col-md-12">
