...
from .consumers import ClueBoxConsumer, CheckBoxConsumer, DoubleAgentConsumer, TeamPointsConsumer, PlayersConsumer #, CheckBoxConsumer # import all consumers here
