...
from .consumers import ClueBoxConsumer, CheckBoxConsumer, DoubleAgentConsumer, TeamPointsConsumer, PlayersConsumer, WinLoseConsumer #, CheckBoxConsumer # import all consumers here
